...
class Exploit(TCPClient):
    __info__ = {
        "name": "scanner_ms17-010",
        "description": "scanner_ms17-010",
        "authors": (
            "jiushi",
        ),
        "references": (
